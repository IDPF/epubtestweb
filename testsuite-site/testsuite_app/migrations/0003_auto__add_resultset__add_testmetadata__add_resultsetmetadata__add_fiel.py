...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('testsuite_app_result_set', (
            ...
            ('metadata', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['testsuite_app.ResultSetMetadata'], null=True, blank=True)),
        ...
        db.create_table('testsuite_app_test_metadata', (
            ...
            ('access_type', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('is_advanced', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('testsuite_app', ['TestMetadata'])

        # Adding model 'ResultSetMetadata'
        db.create_table('testsuite_app_result_set_metadata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('assistive_technology', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('testsuite_app', ['ResultSetMetadata'])

        # Adding field 'Result.result_set'
        db.add_column('testsuite_app_result', 'result_set',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['testsuite_app.ResultSet'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Evaluation.accessibility_testsuite'
        db.add_column('testsuite_app_evaluation', 'accessibility_testsuite',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='evaluation_accessibility_testsuite', null=True, to=orm['testsuite_app.TestSuite']),
                      keep_default=False)

        # Adding field 'Category.temp_flag'
        db.add_column('testsuite_app_category', 'temp_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TestSuite.testsuite_type'
        db.add_column('testsuite_app_testsuite', 'testsuite_type',
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ResultSetMetadata'
        db.delete_table('testsuite_app_result_set_metadata')

        # Deleting field 'Result.result_set'
        db.delete_column('testsuite_app_result', 'result_set_id')

        # Deleting field 'Evaluation.accessibility_testsuite'
        db.delete_column('testsuite_app_evaluation', 'accessibility_testsuite_id')

        # Deleting field 'Category.temp_flag'
        db.delete_column('testsuite_app_category', 'temp_flag')

        # Deleting field 'TestSuite.testsuite_type'
        db.delete_column('testsuite_app_testsuite', 'testsuite_type')
    ...
    models = {
        ...
        'testsuite_app.testmetadata': {
            ...
            'access_type': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TestMetadata.access_type'
        db.delete_column('testsuite_app_test_metadata', 'access_type')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'TestMetadata.access_type'
        db.add_column('testsuite_app_test_metadata', 'access_type',

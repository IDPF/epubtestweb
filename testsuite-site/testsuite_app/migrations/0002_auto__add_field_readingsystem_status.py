...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReadingSystem.status'
        db.add_column('testsuite_app_readingsystem', 'status',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReadingSystem.status'
        db.delete_column('testsuite_app_readingsystem', 'status')

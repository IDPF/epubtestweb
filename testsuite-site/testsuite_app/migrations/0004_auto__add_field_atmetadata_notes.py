...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ATMetadata.notes'
        db.add_column('testsuite_app_atmetadata', 'notes',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ATMetadata.notes'
        db.delete_column('testsuite_app_atmetadata', 'notes')

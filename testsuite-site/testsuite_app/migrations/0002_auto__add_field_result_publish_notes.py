...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Result.publish_notes'
        db.add_column('testsuite_app_result', 'publish_notes',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Result.publish_notes'
        db.delete_column('testsuite_app_result', 'publish_notes')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResultSet.user'
        db.add_column('testsuite_app_result_set', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['testsuite_app.UserProfile'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResultSet.user'
        db.delete_column('testsuite_app_result_set', 'user_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResultSetMetadata.is_keyboard'
        db.add_column('testsuite_app_result_set_metadata', 'is_keyboard',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ResultSetMetadata.is_mouse'
        db.add_column('testsuite_app_result_set_metadata', 'is_mouse',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ResultSetMetadata.is_touch'
        db.add_column('testsuite_app_result_set_metadata', 'is_touch',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ResultSetMetadata.is_screenreader'
        db.add_column('testsuite_app_result_set_metadata', 'is_screenreader',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ResultSetMetadata.is_braille'
        db.add_column('testsuite_app_result_set_metadata', 'is_braille',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResultSetMetadata.is_keyboard'
        db.delete_column('testsuite_app_result_set_metadata', 'is_keyboard')

        # Deleting field 'ResultSetMetadata.is_mouse'
        db.delete_column('testsuite_app_result_set_metadata', 'is_mouse')

        # Deleting field 'ResultSetMetadata.is_touch'
        db.delete_column('testsuite_app_result_set_metadata', 'is_touch')

        # Deleting field 'ResultSetMetadata.is_screenreader'
        db.delete_column('testsuite_app_result_set_metadata', 'is_screenreader')

        # Deleting field 'ResultSetMetadata.is_braille'
        db.delete_column('testsuite_app_result_set_metadata', 'is_braille')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccessibilityScore.result_set'
        db.add_column('testsuite_app_accessibilityscore', 'result_set',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['testsuite_app.ResultSet'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccessibilityScore.result_set'
        db.delete_column('testsuite_app_accessibilityscore', 'result_set_id')

...
class EditEvaluationView(UpdateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        default_result_set = evaluation.get_default_result_set()
        results_form = ResultFormSet(instance = default_result_set, queryset=evaluation.get_category_results(cat, default_result_set))
    ...
    def post(self, request, *args, **kwargs):
        ...
        evaluation = rs.get_current_evaluation()
        default_result_set = evaluation.get_default_result_set()
        formset = ResultFormSet(request.POST, instance=default_result_set)

...
urlpatterns = patterns('',
    ...
    (r'^rs/(?P<pk>\d+)/accessibility/$', AccessibilityReadingSystemView.as_view()),
    ...
    (r'^rs/(?P<pk>\d+)/eval/accessibility/$', login_required(function=EditAccessibilityEvaluationView.as_view(), login_url='/login/')),

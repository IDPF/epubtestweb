...
class EpubParser:
    ...
    def parse(self, filename, category, testsuite):
        ...
        self.epub = import_testsuite.add_epub(self.epubid, self.title, self.description, category)
    ...
    def process_toc(self, elm, epub, ):
        order_in_book = 0
        for li in elm.xpath("//xhtml:li", namespaces = NSMAP):
            ...
            if len(xpathres) != 0:
                ...
                if test_section != None:
                    ...
                    import_testsuite.add_test(name, desc, self.category, required, 
